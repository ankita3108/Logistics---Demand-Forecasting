...
set_input_dir()
data <- read.csv("Soya_TO.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
set_plot_dir()
jpeg('Soya_TO.jpg')
plot(org_ts,ylab="Plantation ('000 ha)", main="Plantation Forecast - Soya (TO)")
lines(pred,col="red")
dev.off()
...
set_output_dir()
write.csv(dataframe,file = "Predicted-Plantation_TO.csv",row.names=FALSE)