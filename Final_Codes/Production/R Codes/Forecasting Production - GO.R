...
agro_yearly_pred<-subset(agro_yearly, UF=='GO' & Produto=='Milho 2 Safra' & Type=='Producao' & Start_Year>=(max_year-1))
...
agro_monthly_act<-subset(agro_yearly, UF=='GO' & Produto=='Milho 2 Safra' & Type=='Producao' & Start_Year>=(max_year-1))
...
set_input_dir()
data <- read.csv("Milho2_GO.csv", header = T, stringsAsFactors = FALSE)
str(data)
