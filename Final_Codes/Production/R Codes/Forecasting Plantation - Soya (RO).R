...
set_input_dir()
data <- read.csv("Soya_RO.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
set_plot_dir()
jpeg('Soya_RO.jpg')
plot(org_ts,ylab="Plantation ('000 ha)", main="Plantation Forecast - Soya (RO)")
lines(pred,col="red")
dev.off()
...
set_output_dir()
write.csv(dataframe,file = "Predicted-Plantation_RO.csv",row.names=FALSE)
