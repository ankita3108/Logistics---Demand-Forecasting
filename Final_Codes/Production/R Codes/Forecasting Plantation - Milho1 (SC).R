...
set_input_dir()
data <- read.csv("Milho1_SC.csv", header = T, stringsAsFactors = FALSE)
str(data)
...
set_plot_dir()
jpeg('Milho1_SC.jpg')
plot(org_ts,ylab="Plantation ('000 ha)", main="Plantation Forecast - Milho1 (SC)")
lines(pred,col="red")
dev.off()
...
set_output_dir()
write.csv(dataframe,file = "Predicted-Plantation_SC.csv",row.names=FALSE)
